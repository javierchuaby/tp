...
public class CommandTestUtil {
    ...
    public static final int VALID_YEAROFSTUDY_AMY = 1;
    public static final int VALID_YEAROFSTUDY_BOB = 2;
    public static final String VALID_FACULTY_AMY = "Faculty of Science";
    ...
    public static final String INVALID_YEAROFSTUDY_DESC = " " + PREFIX_YEAROFSTUDY + "5"; // must be 1-4
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withYearOfStudy(VALID_YEAROFSTUDY_AMY).withFaculty(VALID_FACULTY_AMY)
                .withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
                .withYearOfStudy(VALID_YEAROFSTUDY_BOB).withFaculty(VALID_FACULTY_BOB)
